...
class Menu:
    ...
    def vytvor_text(self) -> None:
        ...
        self.nastavenia_button = VytvorText2(self.screen, "NASTAVENIA", 80, (0,700), font_path=None, text_color= (255,0,0), hover_color=(255,0,100))
    ...
    def menu_loop(self) -> None:
        while self.running:
            ...
            self.start_button.draw(True)
            self.save_button.draw(True)
            self.nastavenia_button.draw(True)
                
            pg.display.flip()
            self.clock.tick(60)

class VytvorText2:
    def __init__(self, screen: pg.Surface, text: str, font_size: int, position: tuple, text_color=(0,0,0), hover_color=(150, 150, 150), font_path=None, speed: float = 5.0) -> None:
        self.screen = screen
        self.text = text
