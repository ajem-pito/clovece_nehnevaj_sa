...
class Menu:
    ...
    def vytvor_texty(self):
        ...
        self.podpis = Vytvor_text(None, "Jakub J. Stefancik, Jakub Pitonak, 2024", (SCREEN_WIDTH-550, SCREEN_HEIGHT-30), 25, 0, font_path, 0, farba=(128, 128, 128))
    ...
    def background_panacik(self) -> None:        
        ...
        for farbicka in farba:
            for _ in range(4):
                ...
                self.panacikovia.append(Panacik(x,y,farbicka,1, scale=1, speed=2))
